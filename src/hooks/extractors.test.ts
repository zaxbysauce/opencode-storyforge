...
describe('Case-insensitive heading matching', () => {
	it('extractCurrentPhase should match "WORKFLOW STATUS" (uppercase)', () => {
		const content = `# Project Plan
...
- Decision 1: Use TypeScript`;
	...
	it('extractCurrentPhase should match "workflow status" (lowercase)', () => {
		const content = `# Project Plan
...
- Decision 1: Use TypeScript`;
	...
	it('extractCurrentPhase should match "Workflow Status" (mixed case)', () => {
		const content = `# Project Plan
...
- Decision 1: Use TypeScript`;
	...
	it('extractCurrentPhase should match "Status" (title case)', () => {
		const content = `# Project Plan
...
- Decision 1: Use TypeScript`;
	...
	it('extractCurrentPhase should match "STATUS" (uppercase)', () => {
		const content = `# Project Plan
...
- Decision 1: Use TypeScript`;
	...
	it('extractDecisions should match "DECISIONS" (uppercase)', () => {
		const content = `# Context
...
- Not a decision`;
	...
	it('extractDecisions should match "decisions" (lowercase)', () => {
		const content = `# Context
...
- Not a decision`;
	...
	it('extractIncompleteTasks should match "WORKFLOW STATUS" (uppercase)', () => {
		const content = `# Project Plan
